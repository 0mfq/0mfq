...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " 0mfq-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  0mfq-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoin transaction\n" +
            "or:     0mfq-tx [options] -create [commands]   Create hex-encoded bitcoin transaction\n" +
            "\n";
