...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //0MFQTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::Stake0MFQs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::Stake0MFQs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    Stake0MFQs(true, connman, mempool);
}
