 ...
 */
static const char* BITCOIN_PID_FILENAME = "0mfqd.pid";
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/0mfq577/0mfq>";

    return (strprintf(_("Copyright (C) %i The 0mfq Core Developers").translated, COPYRIGHT_YEAR) + " ") +
           "\n" +
