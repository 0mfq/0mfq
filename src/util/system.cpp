...
const char * const BITCOIN_CONF_FILENAME = "0mfq.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\0mfq
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\0mfq
    // Mac: ~/Library/Application Support/0mfq
    // Unix: ~/.0mfq
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "0mfq";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/0mfq";
#else
    // Unix
    return pathRet / ".0mfq";
#endif
