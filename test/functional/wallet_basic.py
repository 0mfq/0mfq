...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 0MFQ from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 0MFQ in block rewards plus fees, but
        ...
        # Send 10 0MFQ with subtract fee from amount
        ...
        # Sendmany 10 0MFQ with subtract fee from amount
        ...
        # This will raise an exception for attempting to get the private key of an invalid 0mfq address
        assert_raises_rpc_error(-5, "Invalid 0mfq address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid 0mfq address
        assert_raises_rpc_error(-5, "Invalid 0mfq address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid 0mfq address or script", self.nodes[0].importaddress, "invalid")
